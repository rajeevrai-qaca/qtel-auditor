...
const AUDIT_STRUCTURE = {
  ...
  sections: [
...

    {
      ...
      status: "FINAL — confirmed July 7",
      checkpoints: [
        { id: "2.1", label: "Mixture machine available", type: "yesno", photoRequiredIf: ["Yes"] },
        { id: "2.2", label: "Vibrators available — minimum 2 nos. required", type: "count", min: 2, unit: "nos", photoRequiredIfMet: true },
        { id: "2.3", label: "Slump cone available", type: "yesno", photoRequiredIf: ["Yes"] },
        { id: "2.4", label: "Chute available", type: "yesno", options: ["Yes", "No", "NA"], photoRequiredIf: ["Yes"] },
        { id: "2.5", label: "RMC pump available (if RMC)", type: "yesno", options: ["Yes", "No", "NA"], photoRequiredIf: ["Yes"] },
        { id: "2.6", label: "Dewatering pump available (if required)", type: "yesno", options: ["Yes", "No", "NA"], photoRequiredIf: ["Yes"] },
        { id: "2.7", label: "Shuttering material — Steel plate or waterproof ply with batten", type: "yesno", options: ["Ok", "Not Ok"], photoRequired: true },
        { id: "2.8", label: "Steel available and completed", type: "yesno", photoRequired: true },
        { id: "2.9", label: "Cement available", type: "yesno", photoRequiredIf: ["Yes"] },
        { id: "2.10", label: "Aggregates (coarse and fine) available", type: "yesno", photoRequiredIf: ["Yes"] },
...

    {
      ...
      checkpoints: [
        ...
        { id: "3.18", label: "Precast cover blocks available", type: "yesno", photoRequiredIf: ["Yes"] },
...

    {
      ...
      appliesTo: ["C1"],
      status: "FINAL — confirmed July 7, restructured per your July 8 sketch (Foundation/Column reinforcement table)",
      checkpoints: [
        ...
        { id: "7.fdn.topx", label: "Foundation Reinforcement — Top Bars in X Direction", type: "rebar_row",
          secondLabel: "Spacing (c/c)", secondUnit: "mm", secondCompare: "tolerance", tolerance: 10, photoRequired: true },
        { id: "7.fdn.topy", label: "Foundation Reinforcement — Top Bars in Y Direction", type: "rebar_row",
          secondLabel: "Spacing (c/c)", secondUnit: "mm", secondCompare: "tolerance", tolerance: 10, photoRequired: true },
        { id: "7.fdn.botx", label: "Foundation Reinforcement — Bottom Bars in X Direction", type: "rebar_row",
          secondLabel: "Spacing (c/c)", secondUnit: "mm", secondCompare: "tolerance", tolerance: 10, photoRequired: true },
        { id: "7.fdn.boty", label: "Foundation Reinforcement — Bottom Bars in Y Direction", type: "rebar_row",
          secondLabel: "Spacing (c/c)", secondUnit: "mm", secondCompare: "tolerance", tolerance: 10, photoRequired: true },

        { id: "7.col.main1", label: "Column Reinforcement — Main Bars, Type 1", type: "rebar_row",
          secondLabel: "Number of Bars", secondUnit: "nos", secondCompare: "match", photoRequired: true },
        { id: "7.col.main2", label: "Column Reinforcement — Main Bars, Type 2", type: "rebar_row",
          secondLabel: "Number of Bars", secondUnit: "nos", secondCompare: "match", photoRequired: true },
        { id: "7.col.stirrup", label: "Column Reinforcement — Shear Stirrups / Set", type: "rebar_row",
          secondLabel: "Spacing (c/c)", secondUnit: "mm", secondCompare: "tolerance", tolerance: 10, photoRequired: true },
